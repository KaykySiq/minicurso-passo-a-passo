...
## 📅 DIA 1 — "Como a Web Funciona + Django do Zero"


### ⏱️ Bloco 1 — Criando o Projeto do Zero


#### 1.2 Ambiente virtual e Django
...
> O `.` no final cria na pasta atual, sem subpasta desnecessária.



**Passo 2 — Criar o app de posts**
...
**Passo 3 — Rodar o servidor pela primeira vez**
...
Acessar `http://127.0.0.1:8000` — página de boas-vindas do Django.
...
### ⏱️ Bloco 2 — Estrutura e Configuração
